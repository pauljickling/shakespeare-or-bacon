...
with open('data/shakespeare_words.csv', 'w', newline='') as csvfile:
	csvwriter = csv.writer(csvfile)
	csvwriter.writerow(['word'])
	for i in shakespeare_list:
		csvwriter.writerow([i])

with open('data/bacon_words.csv', 'w', newline='') as csvfile:
	csvwriter = csv.writer(csvfile)
	csvwriter.writerow(['word'])
	for i in bacon_list:
		csvwriter.writerow([i])

with open('data/shakespeare_count.csv', 'w', newline='') as csvfile:
	csvwriter = csv.writer(csvfile)
	csvwriter.writerow(['word'] + ['frequency'])
	for k, v in s_counter.items():
		csvwriter.writerow([k] + [v])

with open('data/bacon_count.csv', 'w', newline='') as csvfile:
	csvwriter = csv.writer(csvfile)
	csvwriter.writerow(['word'] + ['frequency'])
